                ...
                while (stones > 3) or (stones < 1):
                    ...
                    if (pile == 1) and (pile1 >= stones):
                        ...
                        if (pile1 <= 0) and (pile2 <= 0):
                            ...
                            if (pile2 > 1)and(pile1==1):
                                # If the pile2 is not taken empty.
                                X2=pile2-1
                                pile2 = pile2 - X2
                                print("Computer -> ",end='')
                                print("Remove",X2, "stones from pile 2")
                                print("Pile 1:",pile1,"   Pile 2:",pile2)
                            elif (pile1 > 1)and(pile2==1):
                                # If the pile2 is not taken empty.
                                X1=pile1-1
                                pile1 = pile1 - X1
                                print("Computer -> ",end='')
                                print("Remove",X1, "stones from pile 2")
                                print("Pile 1:",pile1,"   Pile 2:",pile2)
